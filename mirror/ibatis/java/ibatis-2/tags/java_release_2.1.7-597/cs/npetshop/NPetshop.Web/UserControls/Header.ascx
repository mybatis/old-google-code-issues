...
<table cellspacing="0" cellpadding="0" width="100%" height="49" background="@Images/top_stripe1.gif"
	border="0">
	<tr>
		<td valign="top"><img src="../@Images/space.gif" width="1" height="13" runat="server" id="space0"><br>
			<img src="../@Images/space.gif" width="14" height="1" runat="server" id="space1"><a href="Default.aspx"><img alt="" src="../@Images/title.gif" border="0" runat="server" id="title"></a></td>
	</tr>
</table>
